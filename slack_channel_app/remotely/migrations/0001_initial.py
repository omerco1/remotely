    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channels', models.ManyToManyField(blank=True, related_name='members', to='remotely.Channel')),
            ],
        ),
        migrations.AddField(
            model_name='channel',
            name='messages',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='remotely.Message'),
        ),
    ]
